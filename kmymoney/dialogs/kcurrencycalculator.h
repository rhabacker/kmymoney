...
public:
  /**
    ...
    */
  KCurrencyCalculator(const MyMoneySecurity& from, const MyMoneySecurity& to, const MyMoneyMoney& value, const MyMoneyMoney& shares, const MyMoneyDate& date, const signed64 resultFraction = 100, QWidget *parent = 0);
  ~KCurrencyCalculator();
