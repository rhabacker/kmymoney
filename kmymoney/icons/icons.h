...
enum class Icon { OpenDatabase, Link, Unlink, Reconcile, Split, Tip, PerformanceTest,
                  ...
                  TransactionStateNotMarked, TransactionStateCleared, TransactionStateNotCleared,
                  TransactionStateHasNumber, TransactionStateNoNumber, TransactionStateHasMemo, TransactionStateNoMemo,
