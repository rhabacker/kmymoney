...
enum class Icon { OpenDatabase, Link, Unlink, Reconcile, Split, Tip, PerformanceTest,
                  ...
                  TransactionStateAny,
                  TransactionStateCleared,
                  TransactionStateErroneous,
                  TransactionStateHasMemo,
                  TransactionStateHasNumber,
                  TransactionStateImported,
                  TransactionStateMatched,
                  TransactionStateNoMemo,
                  TransactionStateNoNumber,
                  TransactionStateNotCleared,
                  TransactionStateNotMarked,
                  TransactionStateNotReconciled,
                  TransactionStateReconciled,
                  TransactionStateScheduled,
