...
void QueryTable::init()
{
    ...
    if (m_config.isPerformanceReport()) {
        ...
        auto selectedPerformanceColumns = qc & (eMyMoney::Report::performanceColumns() | eMyMoney::Report::Performance);
        selectedPerformanceColumns = eMyMoney::Report::expandPerformanceColumns(selectedPerformanceColumns);
        ...
        default:
            addPerformanceColumn(eMyMoney::Report::QueryColumn::PerformanceStartingMarketValue, ctStartingMarketValue);
            break;
        }
        addPerformanceColumn(eMyMoney::Report::QueryColumn::PerformanceBuys, ctBuys);
        if (m_config.investmentSum() != eMyMoney::Report::InvestmentSum::Owned)
            addPerformanceColumn(eMyMoney::Report::QueryColumn::PerformanceSells, ctSells);
        ...
        addPerformanceColumn(eMyMoney::Report::QueryColumn::PerformanceReturn, ctReturn);
        addPerformanceColumn(eMyMoney::Report::QueryColumn::PerformanceReturnInvestment, ctReturnInvestment);
        addPerformanceColumn(eMyMoney::Report::QueryColumn::PerformanceAnnualizedReturn, ctAnnualizedReturn);
        addPerformanceColumn(eMyMoney::Report::QueryColumn::PerformanceExtendedInternalRateOfReturn, ctExtendedInternalRateOfReturn);
