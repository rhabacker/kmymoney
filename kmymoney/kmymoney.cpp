    ...
    */
    ...
    // *************
    {
        ...
        const QVector<actionInfo> actionInfos {
            ...
            {Action::AddReconciliationEntry,        QStringLiteral("reconciliation_add_entry"),       i18n("Add reconciliation entry"),                   Icon::ReconciliationAddEntry},
            {Action::EditReconciliationEntry,       QStringLiteral("reconciliation_edit_entry"),      i18n("Edit reconciliation entry"),                  Icon::TransactionEdit},
...
//      {Action::ToolSQL,                       &KMyMoneyApp::slotGenerateSql},
    ...
    // *************
    {
        const QVector<QPair<Action, QKeySequence>> actionShortcuts {
            ...
            {qMakePair(Action::AddReconciliationEntry,      Qt::CTRL + Qt::SHIFT + Qt::Key_B)},
            {qMakePair(Action::EditReconciliationEntry,     Qt::CTRL + Qt::SHIFT + Qt::Key_E)},
