...
KMM_MYMONEY_EXPORT QDebug operator<<(QDebug dbg, const MyMoneyMoney &a);
KMM_MYMONEY_EXPORT QDebug operator<<(QDebug dbg, QList<MyMoneyMoney> &a);
KMM_MYMONEY_EXPORT QDebug operator<<(QDebug dbg, QMap<QString, MyMoneyMoney> &a);
KMM_MYMONEY_EXPORT QDebug operator<<(QDebug dbg, QMap<QDate, MyMoneyMoney> &a);
KMM_MYMONEY_EXPORT QDebug operator<<(QDebug dbg, QMap<int, MyMoneyMoney> &a);
#endif
