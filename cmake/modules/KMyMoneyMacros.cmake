...
# @param OUTPUT_DIR <dir>   the directory where to create the output
    ...
    foreach(lang_dir ${lang_dirs})
        ...
        foreach(docbook ${docbooks})
            ...
            if (match)
                ...
                # add base set of images
                COPYDIR(
                    SOURCES doc
                    TYPES *.png *.svg *.css
                    OUTPUT_DIR ${OUTPUT_DIR}/kmymoney
                    RETURN_SOURCE_NAMES image_files
                )
                # overwrite with translated images
                COPYDIR(
                ...
                install(FILES ${image_files} DESTINATION ${KDE_INSTALL_DOCBUNDLEDIR}/${lang}/kmymoney)
                add_docbook(
                    index
